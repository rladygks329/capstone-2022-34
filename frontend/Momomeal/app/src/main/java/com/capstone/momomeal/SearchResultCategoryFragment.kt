...
class SearchResultCategoryFragment : BaseFragment<FragmentSearchResultCategoryBinding>(FragmentSearchResultCategoryBinding::inflate) {
    val chatlist = arrayListOf<Chatroom>(
        //test
        Chatroom("카테고리 1 ", 123, Category.Chicken, 3, "국민대학교 정문", 3.3, listOf(7, 49, 89)),
        Chatroom("카테고리 2", 128, Category.BoiledPork, 3, "서울대입구 4번출구", 3.9, listOf(3, 29, 69))
    )
